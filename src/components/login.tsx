  ...
  return (
    <div style={{ position: 'relative', minHeight: '100dvh', background: bg, display: 'flex', overflow: 'hidden' }}>
      ...
      <div className="hidden md:flex" style={{
        ...
        >
          ...
          <h1 style={{
            ...
            lineHeight: 1.0, color: text, margin: 0,
          }}>
        ...
        <p style={{
          ...
          fontSize: 11, color: muted, letterSpacing: '0.04em', margin: 0,
        }}>
      ...
      >
        ...
        <AnimatePresence mode="wait">
          {!showEmail ? (
            ...
            >
              ...
              {flow === 'signUp' && err(eUp.root?.message)}
              ...
              <button
                ...
                style={{
                  background: 'none', border: 'none', cursor: 'pointer',
                  fontSize: 13, color: muted, letterSpacing: '-0.01em',
                  padding: '2px 0', textAlign: 'center', transition: 'color 0.15s',
                }}
                onMouseEnter={e => e.currentTarget.style.color = text}
                onMouseLeave={e => e.currentTarget.style.color = muted as string}
              >
        ...
        {/* Switch flow — shown only before email form opens */}
        {!showEmail && (
        ...
        <p style={{ fontSize: 11, color: muted, margin: '10px 0 0', letterSpacing: '-0.01em', opacity: 0.65 }}>
          ...
          {' '}and{' '}
          <Link href="#" style={{ color: text, textDecoration: 'underline', textUnderlineOffset: 2 }}>Privacy Policy</Link>
        </p>
