...
const TRACES: Trace[] = [
  {
    ...
    dur: 7, begin: 0,
    vias: [
      { x: 300, y: 200, begin: 0.85 },
      { x: 300, y: 400, begin: 1.6 },
      { x: 700, y: 400, begin: 2.8 },
      { x: 700, y: 100, begin: 3.6 },
      { x: 1100, y: 100, begin: 4.8 },
      { x: 1100, y: 500, begin: 6.0 },
    ],
  },
  {
    id: 'circuit-t2',
    ...
    dur: 8.5, begin: 1.5,
    vias: [
      { x: 200, y: 620, begin: 1.0 },
      { x: 200, y: 820, begin: 1.9 },
      { x: 600, y: 820, begin: 3.3 },
      { x: 600, y: 520, begin: 4.3 },
      { x: 900, y: 520, begin: 5.6 },
      { x: 900, y: 720, begin: 6.7 },
    ],
  },
  {
    id: 'circuit-t3',
    ...
    dur: 6.4, begin: 3.0,
    vias: [
      { x: 950, y: 450, begin: 0.7 },
      { x: 950, y: 250, begin: 1.4 },
      { x: 550, y: 250, begin: 2.5 },
      { x: 550, y: 450, begin: 3.2 },
      { x: 150, y: 450, begin: 4.4 },
      { x: 150, y: 150, begin: 5.1 },
    ],
  },
  {
    id: 'circuit-t4',
    ...
    dur: 9, begin: 0.6,
    vias: [
      { x: 400, y: 50, begin: 1.1 },
      { x: 400, y: 250, begin: 2.2 },
      { x: 800, y: 250, begin: 3.6 },
      { x: 800, y: 50, begin: 4.7 },
      { x: 1200, y: 50, begin: 6.1 },
      { x: 1200, y: 350, begin: 7.4 },
    ],
  },
  {
    id: 'circuit-t5',
    ...
    dur: 7.8, begin: 2.4,
    vias: [
      { x: 300, y: 850, begin: 0.9 },
      { x: 300, y: 650, begin: 1.8 },
      { x: 700, y: 650, begin: 3.2 },
      { x: 700, y: 850, begin: 4.1 },
      { x: 1100, y: 850, begin: 5.7 },
      { x: 1100, y: 750, begin: 6.5 },
    ],
  },
]
